...
$con = connect_mysql ();
$id_author = validar_login ( '/editeducation.php' );
$id = $_GET ['id'];
...
$create =  $juandi->education->update_education($title, $place, $years, $con );
if ( $create) {
...
<div class="container">
  <h4> Editar estudio <?  print $juandi->education->name ?> </h4>
<br>
  ...
  <form class="col s12" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="input-field col s12">
        <input id="title" type="text" name = "title" value="<? print $juandi->education->title?>">
        <label class="active" for="title"  >Título</label>
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <input id="subtitle" type="text" name = "place" value="<? print $juandi->education->place?>"  >
        <label for="subtitle">Lugar</label>
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <input id="subtitle" type="text" name = "years" value="<? print $juandi->education->years?>"  >
